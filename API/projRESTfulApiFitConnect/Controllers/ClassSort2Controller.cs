...
namespace projRESTfulApiFitConnect.Controllers
{
    ...
    [ApiController]
    public class ClassSort2Controller : ControllerBase
    {
        private readonly GymContext _context;
        private readonly IWebHostEnvironment _env;

        public ClassSort2Controller(GymContext context, IWebHostEnvironment env)
        {
            _context = context;
            _env = env;
        }
